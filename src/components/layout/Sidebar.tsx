          ...
          conversations.map((conv) => {
            ...
            return (
              <div
                ...
                className={`group relative flex items-center justify-between px-3 py-2.5 rounded-xl text-sm transition-colors cursor-pointer ${
                  isActive
                  ...
                  {isEditing ? (
                    <div className="flex items-center gap-1 flex-1" onClick={(e) => e.stopPropagation()}>
                      <input
                        ...
                        autoFocus
                        className="w-full bg-white px-2 py-1 text-sm rounded border border-blue-500 focus:outline-none"
                      />
                      <button
                        type="button"
                    ...
                    <div className="flex flex-col min-w-0 flex-1">
                      <span className="truncate leading-snug text-sm">{conv.title}</span>
                ...
                {!isEditing && (
                  <div className="relative shrink-0">
                    <button
                      ...
                      className={`p-1.5 rounded hover:bg-gray-200/60 text-gray-400 hover:text-gray-700 transition-opacity ${
                    ...
                    {menuOpenId === conv.id && (
                      <div
                        ref={menuRef}
                        className="absolute right-0 top-full mt-1 w-32 bg-white border border-gray-200 rounded-xl shadow-lg py-1 z-30 animate-in fade-in zoom-in-95"
                      >
                        <button
                          type="button"
                          onClick={(e) => handleStartRename(conv, e)}
                          className="w-full flex items-center gap-2 px-3 py-2 text-xs font-medium text-gray-700 hover:bg-gray-100 text-left"
                        >
